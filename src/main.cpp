...
#define MQTT_TOPIC_PUBLISH "esp32_mirza/data/lux"
#define MQTT_TOPIC_PUBLISH2 "esp32_mirza/data/humid"
#define MQTT_TOPIC_PUBLISH3 "esp32_mirza/data/temp"
#define MQTT_TOPIC_SUBSCRIBE "esp32_mirza/cmd/#"
...
void onPublishMessageLux()
{
  ...
  {
    Serial.printf("Safedoor is Closed = %.2f lux\n", lux);
    digitalWrite(LED_RED, LOW);
    digitalWrite(LED_GREEN, HIGH);
  }
  else if (lightMeter.readLightLevel() > 400)
  {
    Serial.printf("Safedoor is Opened = %.2f lux\n", lux);
